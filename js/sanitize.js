...
function sanitizeElementTree(root) {
  Array.from(root.childNodes).forEach(node => {
    ...
    Array.from(node.attributes).forEach(attr => {
      ...
      if (['data-ending-block','data-ending-type','data-theme-component','data-theme-role','data-layout','data-editor-highlight','data-editor-green','data-hr-style','data-user-align','data-img-id','data-intro-variant','data-theme-avatar'].includes(name)) return;
      node.removeAttribute(attr.name);
    });
